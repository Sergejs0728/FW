...
// Make changes to DeviceArea.m instead.

#import "_DeviceArea.h"

@implementation DeviceAreaID
@end

@implementation _DeviceArea

+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription insertNewObjectForEntityForName:@"DeviceArea" inManagedObjectContext:moc_];
}
...
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription entityForName:@"DeviceArea" inManagedObjectContext:moc_];
}

- (DeviceAreaID*)objectID {
	return (DeviceAreaID*)[super objectID];
}
...
@implementation DeviceAreaAttributes 
+ (NSString *)account_id {
	return @"account_id";
}
+ (NSString *)created_at {
