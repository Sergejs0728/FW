...
// Make changes to DeviceArea.h instead.
...
@interface DeviceAreaID : NSManagedObjectID {}
@end

@interface _DeviceArea : NSManagedObject
+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_;
+ (NSString*)entityName;
+ (nullable NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) DeviceAreaID *objectID;
...
@interface _DeviceArea (CoreDataGeneratedPrimitiveAccessors)
...
@interface DeviceAreaAttributes: NSObject 
+ (NSString *)account_id;
+ (NSString *)created_at;
+ (NSString *)entity_id;
+ (NSString *)name;
