...
// Make changes to ActivityLevel.h instead.
...
@interface ActivityLevelID : NSManagedObjectID {}
@end

@interface _ActivityLevel : NSManagedObject
+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_;
+ (NSString*)entityName;
+ (nullable NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) ActivityLevelID *objectID;
...
@interface _ActivityLevel (CoreDataGeneratedPrimitiveAccessors)
...
@interface ActivityLevelAttributes: NSObject 
+ (NSString *)account_id;
+ (NSString *)created_at;
+ (NSString *)entity_id;
+ (NSString *)name;
