...
// Make changes to FlatType.h instead.
...
@interface FlatTypeID : NSManagedObjectID {}
@end

@interface _FlatType : NSManagedObject
+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_;
+ (NSString*)entityName;
+ (nullable NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) FlatTypeID *objectID;
...
@interface _FlatType (CoreDataGeneratedPrimitiveAccessors)
...
@interface FlatTypeAttributes: NSObject 
+ (NSString *)account_id;
+ (NSString *)created_at;
+ (NSString *)entity_id;
+ (NSString *)name;
