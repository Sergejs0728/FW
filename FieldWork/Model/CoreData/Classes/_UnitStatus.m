...
// Make changes to UnitStatus.m instead.

#import "_UnitStatus.h"

@implementation UnitStatusID
@end

@implementation _UnitStatus

+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription insertNewObjectForEntityForName:@"UnitStatus" inManagedObjectContext:moc_];
}
...
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription entityForName:@"UnitStatus" inManagedObjectContext:moc_];
}

- (UnitStatusID*)objectID {
	return (UnitStatusID*)[super objectID];
}
...
@implementation UnitStatusAttributes 
+ (NSString *)account_id {
	return @"account_id";
}
+ (NSString *)created_at {
