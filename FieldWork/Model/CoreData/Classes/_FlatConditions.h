...
// Make changes to FlatConditions.h instead.
...
@interface FlatConditionsID : NSManagedObjectID {}
@end

@interface _FlatConditions : NSManagedObject
+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_;
+ (NSString*)entityName;
+ (nullable NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) FlatConditionsID *objectID;
...
@interface _FlatConditions (CoreDataGeneratedPrimitiveAccessors)
...
@interface FlatConditionsAttributes: NSObject 
+ (NSString *)account_id;
+ (NSString *)created_at;
+ (NSString *)entity_id;
+ (NSString *)name;
