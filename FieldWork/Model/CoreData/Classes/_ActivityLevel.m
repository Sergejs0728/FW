...
// Make changes to ActivityLevel.m instead.

#import "_ActivityLevel.h"

@implementation ActivityLevelID
@end

@implementation _ActivityLevel

+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription insertNewObjectForEntityForName:@"ActivityLevel" inManagedObjectContext:moc_];
}
...
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription entityForName:@"ActivityLevel" inManagedObjectContext:moc_];
}

- (ActivityLevelID*)objectID {
	return (ActivityLevelID*)[super objectID];
}
...
@implementation ActivityLevelAttributes 
+ (NSString *)account_id {
	return @"account_id";
}
+ (NSString *)created_at {
