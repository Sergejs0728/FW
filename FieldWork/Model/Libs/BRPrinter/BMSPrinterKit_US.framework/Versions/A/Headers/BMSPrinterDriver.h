...
//
//  * NOTE: SDK 2.1 decided NOT to send this notification for RJ-4030Ai. So, it is only being sent for PJ-763MFi.
//
...
//    Also, RJ4 will always be using Roll Paper, so it is not necessary (typically) to remind user to insert paper
...
//    This is the default setting for PJ763MFi and RJ4030Ai.
//
