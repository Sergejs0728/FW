...
public class HoshiTextField: TextFieldEffects {
    ...
    override func animateViewsForTextEntry() {
        let oldX = self.placeholderLabel.frame.origin.x;
        if text!.isEmpty {
...
//                self.placeholderLabel.frame.origin = CGPoint(x: self.placeholderLabel.frame.origin.x, y: self.placeholderLabel.frame.origin.y - self.placeholderLabel.frame.size.height - self.placeholderInsets.y)
                self.placeholderLabel.frame.origin = CGPoint(x: oldX, y: self.placeholderLabel.frame.origin.y - self.placeholderLabel.frame.size.height - self.placeholderInsets.y)
