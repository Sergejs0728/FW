...
//	region.span.longitudeDelta = maxLon - minLon;
    ...
    CLLocationCoordinate2D topLeft = [mapView convertPoint:CGPointZero toCoordinateFromView:mapView];
    CLLocationCoordinate2D bottomRight = [mapView convertPoint:CGPointMake(mapView.bounds.size.width, mapView.bounds.size.height) toCoordinateFromView:mapView];
    ...
    @catch (NSException *exception) {
        UIAlertView * alert = [[UIAlertView alloc] initWithTitle:@"Error"
                                                 message:@"Invalid Region, could not calculater the route between given loations."
                                                delegate:nil
